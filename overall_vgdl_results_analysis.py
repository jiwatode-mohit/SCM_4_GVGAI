...
RESULTS_GLOB = os.path.join("vgdl_results", "*_new_paper_stats.txt")
...
def main():
    ...
    files_to_parse = sorted(glob.glob(RESULTS_GLOB))

    if not files_to_parse:
        print(f"No Task 2 stats files found matching: {RESULTS_GLOB}")
        return
